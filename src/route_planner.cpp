...
RouteModel::Node *RoutePlanner::NextNode() {
    sort(this->open_list.begin(), this->open_list.end(), [] (RouteModel::Node *node_1, RouteModel::Node *node_2){return ((node_1->g_value+node_1->h_value) > (node_2->g_value+node_2->h_value));});
